...
import org.usfirst.frc295.Grizzlynator2017.RobotMap.RobotID;
import org.usfirst.frc295.Grizzlynator2017.Logger.Logger;
import org.usfirst.frc295.Grizzlynator2017.Looper.Looper;
import org.usfirst.frc295.Grizzlynator2017.commands.AutonomousCommand;
import org.usfirst.frc295.Grizzlynator2017.subsystems.*;
...
public class Robot extends IterativeRobot
{
	...
	//public static SysAgitator sysAgitator;
	public static SysGearMechanism sysGearMechanism;
	...
	public void robotInit()
	{
		try
		{
			...
			ahrs = new NavX_Gyro();
			sysGearMechanism = new SysGearMechanism();
			sysLift = new SysLift();
			sysIntake = new SysIntake();
			//sysAgitator = new SysAgitator();
	...
	public void disabledPeriodic()
	{
		try
		{
			SmartDashboard.putNumber("ultraosnoic disable periodic distances", sysUltrasonic.SysUltrasonic());
			SmartDashboard.putNumber("Encoder Values", sysDriveTrain.getDistance());
